...
export class TaskRunner {
   ...
   *  instead of started. */
  run(input: { projectPath: string; prompt: string; origin: SessionOrigin; title?: string | null; model?: string; effort?: string; sourceKind?: 'cron' | 'ticket' | 'goal' | 'goal_verify'; sourceId?: string; cwd?: string }): string {
